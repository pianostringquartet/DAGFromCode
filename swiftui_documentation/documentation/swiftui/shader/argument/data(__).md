---
title: data(_:)
description: Returns an argument value defined by the provided data value. When passed to an MSL function it will convert to a  pair of parameters.
source: https://developer.apple.com/documentation/swiftui/shader/argument/data(_:)
timestamp: 2025-10-29T00:09:57.500Z
---
...
> Returns an argument value defined by the provided data value. When passed to an MSL function it will convert to a  pair of parameters.
